                ...
                <div class="card-body mb-4">
                    ...
                    <form id="form-roles-update" action="{{route('roles.update', $role->id)}}" method="post">
                        ...
                        <div class="form-group col-sm-12 mb-3 mb-sm-3">
                            ...
                            <input type="text" class="form-control" name="name" id="name" title="Solo alfanumericos" placeholder="NOMBRE ROL" oninput="nombre_rol(this)" value="{{old('name', $role->name)}}" required>
                        </div>
                        <div class="form-group col-sm-12 mb-3 mb-sm-3">
